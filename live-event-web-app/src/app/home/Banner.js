                ...
                <Row className='mt-xl-5'>
                    <Col xs={12} md={8} xl={6}>
                        <div className='d-flex flex-column' >
                            <h1 className="tagline ps-0 title">FEEL THE SOUND</h1>
                            <h2 className='toRotate'>{toRotate}<span className="wrap">{text}</span></h2>
